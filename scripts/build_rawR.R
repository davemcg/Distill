...
base_path = '/Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/data/'
...
het <- read_tsv('/Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/data/UK10K/UK10K_EGAD.hets.gz', col_types = cols(.default = "c"))
hom <- read_tsv('/Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/data/UK10K/UK10K_EGAD.homs.gz', col_types = cols(.default = "c"))
...
save(raw_data, file='/Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/data/master/raw_data.Rdata')
