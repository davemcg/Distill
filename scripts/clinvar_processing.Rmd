...
library(tidyverse)
library(here)
data_path <- '/Volumes/data/clinvar/projects/nei/mcgaughey/eye_var_Pathogenicity/'

#clinvar_single <- fread('gzcat ~/git/clinvar/output/b37/single/clinvar_alleles.single.b37.tsv.gz')
clinvar_single <- fread(paste('gzcat', here('processed_data/clinvar/clinvar_alleles.single.b37.tsv.gz')))
```
