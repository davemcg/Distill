...
load('/Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/clean_data/allX_2018_06_20.Rdata')
load('/Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/clean_data/model_data_2018_06_20.Rdata')
load('/Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/clean_data/DeepRNN_2018_06_20.Rdata')
...
test_set <- model_data$ML_set__general_TT$test_set %>% select_(.dots=most_imp_predictors_no_disease_class)
...
test_set$VPaC_m15 <- sqrt(predict(VPaC_15mtry, all_sub, type='prob')[,1])
...
```{r}
save(allX, file = '/Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/clean_data/all_data.2018_06_20.Rdata')
load('/Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/clean_data/all_data.2018_06_20.Rdata')
```
...
```{r}
pr_data <- data.frame()
model_vec <- c('DeepRNN','DeepVPAC','VPaC_m06','VPaC_m09','VPaC_m12', 'VPaC_m15', 'revel', 'cadd_phred', 'fitcons', 'metalr_rankscore', 'fathmm_converted_rankscore')
for (i in model_vec){
