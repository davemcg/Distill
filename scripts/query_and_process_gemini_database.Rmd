...
```{r}
library(data.table)
het <- fread('gzcat /Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/data/UK10K_EGAD.hets.gz')
hom <- fread('gzcat /Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/data/UK10K_EGAD.homs.gz')
```
