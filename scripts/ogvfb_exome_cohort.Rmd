...
```{r}
ogvfb <- list()
ogvfb$gemini_ogvfb_candidates  <- gemini_ogvfb_candidates
ogvfb$ogvfb_ML_set <- ogvfb_ML_set

output_file <- '/Volumes/data/projects/nei/mcgaughey/eye_var_Pathogenicity/clean_data/ogvfb_exome_cohort.Rdata'
