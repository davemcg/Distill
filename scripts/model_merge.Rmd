...
stepLDAFit <- caret::train(Status ~ ., data=train_set, 
                      preProcess = c("scale", "center"),
                      method = "stepLDA",  metric='F',
                      trControl = fitControl)
naive_bayesFit <- caret::train(Status ~ ., data=train_set, 
                      preProcess = c("scale", "center"),
                      method = "naive_bayes",  metric='F',
                      trControl = fitControl)
...
svmLinearWeights2Fit <- caret::train(Status ~ ., data=train_set, 
                      preProcess = c("scale", "center"),
                      method = "svmLinearWeights2",  metric='F',
                      trControl = fitControl)

my_models <- list(rfFit,bglmFit,avNNetFit, xgbTreeFit,stepLDAFit, naive_bayesFit, dnnFit)
names(my_models) <- c('rfFit','bglmFit','avNNetFit', 'xgbTreeFit','stepLDAFit', 'naive_bayesFit', 'dnnFit')
