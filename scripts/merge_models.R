...
#VPaC
model_merger(pattern='VPaC__9mtry_v6_*', mtry=9, pac='VPaC_pieces', type='VPaC')
model_merger(pattern='VPaC__12mtry_v6_*', mtry=12, pac='VPaC_pieces', type='VPaC')
model_merger(pattern='VPaC__15mtry_v6_*', mtry=15, pac='VPaC_pieces', type='VPaC')
