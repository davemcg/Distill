...
path_cdot <- panel %>% filter(grepl('Path', `Variant Classification`, ignore.case = T)) %>% select(`Sample ID`, Gene, `Genomic location`, Transcript, `transcript change`, `Codon change`) %>% pull(`transcript change`)
```
